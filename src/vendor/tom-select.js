...
!(function (e, t) {
      ...
      return (
        ...
        n.forEach((e) => {
          ...
          ;(o && (s = e.match(o)) && ((n = s[1]), (e = s[2])),
            e.length > 0 &&
              ((l = this.settings.diacritics ? I(e) || null : r(e)), l && t && (l = '\\b' + l)),
    ...
    _getSortFunction(e) {
      ...
      return s.length
        ? function (e, t) {
            var i, n
            for (let o of s) {
              if (((n = o.field), (i = ('desc' === o.direction ? -1 : 1) * E(r(n, e), r(n, t)))))
                return i
            }
            return 0
          }
        ...
        ? (() => {
            ...
            var f = (e) => {
                var t = Object.assign({}, e.dataset),
                  s = i && t[i]
                return (
                  'string' == typeof s && s.length && (t = Object.assign(t, JSON.parse(s))),
                  t
                )
              },
              m = (e, t) => {
  ...
  class ce extends (function (e) {
      ...
      class extends e {
        ...
        initializePlugins(e) {
          ...
          if (Array.isArray(e))
            ...
            for (t in e) e.hasOwnProperty(t) && ((i.plugins.settings[t] = e[t]), n.push(t))
    ...
    constructor(e, t) {
      ...
      ;((i.tomselect = this),
        (s = (window.getComputedStyle && window.getComputedStyle(i, null)).getPropertyValue(
          'direction'
        )))
      const n = le(i, t)
      ;((this.settings = n),
    ...
    clearActiveOption() {
      ;(this.activeOption &&
        (W(this.activeOption, 'active'), se(this.activeOption, { 'aria-selected': null })),
        (this.activeOption = null),
      ...
      if (t.is_select_tag) {
        ...
        ;(t.input.querySelectorAll('option:checked').forEach((e) => {
          ...
          0 == t.items.length && 'single' == t.settings.mode
            ...
            : t.items.forEach((e) => {
                if (
                  ((s = t.options[e]), (i = s[t.settings.labelField] || ''), o.includes(s.$option))
                ) {
    ...
    close(e = !0) {
      var t = this,
        s = t.isOpen
      ;(e &&
        (t.setTextboxValue(), 'single' === t.settings.mode && t.items.length && t.inputState()),
        (t.isOpen = !1),
